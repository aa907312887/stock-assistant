...
class StockMonthlyBar(Base):
    __tablename__ = "stock_monthly_bar"
    ...
    __table_args__ = (
        UniqueConstraint("stock_code", "trade_month_end", name="uk_monthly_bar_code_date"),
    )
